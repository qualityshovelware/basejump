  ...
  */
    ...
    */
    try {
      /*
        ...
        deload
      */
      if (distanceOf2Points(ent[i].getAttribute("position"), document.getElementById("cam").getAttribute("position")) > 100) {
  ...
  for (i = 0; i < cache.length; i++) {
    try {
      ...
      if (distanceOf2Points(cache[i].getAttribute("position"), cam.getAttribute("position")) < 100) {
